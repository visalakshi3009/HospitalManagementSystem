...
public class HelloApplication extends Application {
    ...
    private VBox createHeader() {
        ...
        Image logoImage = new Image("Caduceus.png");
        ...
        checkAvail.setOnAction(new EventHandler<ActionEvent>(){
            public void handle(ActionEvent e){
                ...
                if(doa.getValue() != null){
                    ...
                    Patient_consultation.arr.insert(new Doctor("Dr. Brown", "Orthopaedics", "03"));
                    ...
                    Patient_consultation.arr.insert(new Doctor("Dr. Lewis", "Neurology", "12"));
                    ...
                    testdoc.setUnavailable(LocalDate.of(2025, 3, 12));
                    if(depts_avail.getValue() != null){
                        try{
